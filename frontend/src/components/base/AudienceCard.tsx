...
export default function AudienceCard({ icon, title, description }: AudienceCardProps) {
  return (
    <div className="h-full bg-background-50 border border-background-200/70 p-6 md:p-7 text-center transition-all duration-300 hover:border-primary-200 hover:shadow-sm">
