...
export default function MembershipGateModal({
  ...
  return (
    <div className="fixed inset-0 z-[120] grid place-items-center overflow-y-auto bg-black/70 p-2 backdrop-blur-sm sm:p-5" role="presentation" onMouseDown={(event) => { if (event.target === event.currentTarget) onClose(); }}>
      <section role="alertdialog" aria-modal="true" aria-labelledby="membership-gate-title" aria-describedby="membership-gate-description" className="my-2 w-full max-w-md border border-primary-500/40 bg-background-50 p-5 shadow-[0_28px_90px_rgba(0,0,0,0.55)] sm:p-7 md:p-9">
