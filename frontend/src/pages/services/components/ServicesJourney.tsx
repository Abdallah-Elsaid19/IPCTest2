  ...
  return (
    <section className="bg-background-100 section-padding">
      <div className="container-content">
        <div className="reveal"><SectionHeader eyebrow="Professional service journey" title="Simple to enter. Structured enough to be credible." subtitle="The first website version can use a direct email-based process while keeping the experience clear and professional." centered /></div>
