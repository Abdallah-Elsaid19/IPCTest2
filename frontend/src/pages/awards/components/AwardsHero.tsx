      ...
      <div className="container-content relative z-10 w-full pt-24 md:pt-32">
        <div className="max-w-3xl reveal">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <a href={content.primary_cta_url} className="btn-primary inline-flex items-center gap-2"><i className="ri-award-line" />{content.primary_cta_label}</a>
            <a href={content.secondary_cta_url} className="btn-secondary inline-flex items-center gap-2"><i className="ri-mail-line" />{content.secondary_cta_label}</a>
          </div>
        </div>
      </div>
    </section>
